...
resource "aws_iam_role_policy_attachment" "app_database" {
  role       = aws_iam_role.app.name
  policy_arn = data.aws_iam_policy.database.arn
}
...
resource "aws_iam_role_policy_attachment" "web_hosting_ssm" {
  role       = aws_iam_role.web_hosting.name
  policy_arn = data.aws_iam_policy.ssm_managed.arn
}

resource "aws_iam_role_policy_attachment" "web_hosting_s3" {
  role       = aws_iam_role.web_hosting.name
